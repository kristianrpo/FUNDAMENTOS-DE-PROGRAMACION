...
public class Main
{
  ...
  /**
   * Este es el método de clase que contiene todo el menu del usuario
   * El método crea un objeto de tipo MarcoDeDatos
   * El método tiene un ciclo infinito que será cerrado por el 0 y siempre muestra las opciones del programa
   * Si el número es diferente a los predeterminados por el sistema el ciclo se repetirá hasta que se marque una opcion válida
   * Una vez el usuario marque una opción el menú lo rediccionará a otra con opciones más especificas
   * Si el usuario ingresa números validos el sistema invocará métodos de la clase MarcoDeDatos
   */
    ...
    while(VF){
      ...
      switch(opcion){
        ...
        case 4: System.out.println("Has seleccionado la opcion 4");
          System.out.println("");
          System.out.println("Ingrese el dato del que desea saber si contiene valores menores o iguales a uno ingresado por usted posteriormente");
          System.out.println("");
          a = mostrarMenuGeneral();
        ...
        case 5:
          ...
          System.out.println("");
          System.out.println("Ingrese el dato del que desea saber si contiene valores mayores o iguales a uno ingresado por usted posteriormente");
          System.out.println("");
          a = mostrarMenuGeneral();
          System.out.println("Ingrese valor a comparar");
        ...
        case 6: System.out.println("Has seleccionado la opcion 6");
          ...
          Sleep();
          break;
        case 7: System.out.println("Has seleccionado la opcion 7");
          System.out.println("");
          ...
          Sleep();
          break;
        case 8: System.out.println("Has seleccionado la opcion 8");
          System.out.println(MD.infoLugarCsv());
          Sleep();
          break;
        case 9: System.out.println("Has seleccionado la opcion 9");
          System.out.println();
  ...
  /**
   * El método de clase es mostrado por mostrarMenu para que el usuario tome acciones más especificas a partir de unas generales
   * El método crea un objeto de tipo MarcoDeDatos
   * El método pide un número válido una vez que el usuario haya ingresado uno diferente a los predeterminados por el sistema
   * @return es un numero que luego servirá como parámetro a algunas acciones de la clase MarcoDeDatos
   */
  ...
  /**
   * El método de clase detiene el programa por 1000 milisegundos para que el usuario pueda visualizar con mayor detenimiento las acciones realizadas por el sistema
   ...
   * @return es un texto que luego será ingresado como parámetro para escribir en el csv
   */
